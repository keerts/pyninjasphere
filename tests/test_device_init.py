...
class DeviceTestCase(unittest.TestCase):
    ...
    def setUp(self):
        self.arguments = {"id" : 1, "naturalId" : "test", "name" : "test", "thingId" : 2, "channels" : None, "signatures" : {"test"}}
        self.device = Device(**self.arguments)
        channel_mapping = {"topic": "testtopic", "schema": "testschema", "supportedMethods": "testmethod",
        ...
        self.arguments_with_channels = {"id" : 1, "naturalId" : "test", "name" : "test", "thingId" : 2, "channels" : self.mapping_of_channel_mappings, "signatures" : {"test"}}
    ...
    def test_channels(self):
        ...
        for channel_mapping in self.mapping_of_channel_mappings:
            self.assertEqual(Channel(**channel_mapping).__dict__,self.device_with_channels.channels[x].__dict__)
            x += 1
