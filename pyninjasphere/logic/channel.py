...
class Channel(Base):
    ...
    def __init__(self,  **kwargs):
        """
        Initializes a channel object by looping through the keywords in kwargs and setting them as attributes.
        :param kwargs: Dictionary
        """
        for keyword in ["topic", "schema", "supportedMethods", "supportedEvents", "id", "protocol", "deviceId", "lastState"]:
